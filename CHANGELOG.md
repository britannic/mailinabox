...
* The control panel sign-in was streamlined: the intermediate landing screen is gone (the browser goes straight to the sign-in form), "Remember me" now lives on that form, and the passkey and password buttons share a single, consistently styled row.

v76-hrc.2 (July 13, 2026)
-------------------------
